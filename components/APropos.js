...
export default function APropos() {
    return (
        <div className="w-full flex flex-col justify-center items-center gap-32 py-20 px-4">
            {/* Section Title */}
            ...
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="flex flex-col space-y-6">
                    <p className="text-2xl lg:text-2xl leading-relaxed font-[family-name:var(--font-anon)]">
